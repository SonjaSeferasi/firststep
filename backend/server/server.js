...
const createReviewRoute = require("./routes/reviews/postReviews");
...
const getMbtaAlertsRoute   = require("./routes/serviceAlerts/getMbtaAlerts");
const getMbtaPlannedRoute  = require("./routes/serviceAlerts/getMbtaPlannedWork");
const getBostonEventsRoute = require("./routes/serviceAlerts/getBostonEvents");
...
app.use("/api/mbta-alerts", getMbtaAlertsRoute);
app.use("/api/mbta-planned", getMbtaPlannedRoute);
app.use("/api/boston-events", getBostonEventsRoute);
